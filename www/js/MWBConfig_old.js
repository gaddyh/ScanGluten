...
MWBSInitSpace.init = function(mwbs,constants,dvc){
    console.log('scanns MWBSInitSpace.init Invoked at: '+ (new Date()).getTime());
	...
	try{
        ...
        mwbs['MWBsetActiveCodes'](constants.MWB_CODE_MASK_EANUPC);
        mwbs['MWBsetLevel'](2);
        ...
        mwbs['MWBsetScanningRect'](constants.MWB_CODE_MASK_EANUPC, 20,20,60,60);
        //mwbs['MWBenableZoom'](true);
        //mwbs['MWBsetZoomLevels'](200, 400, 0);
        //mwbs['MWBsetCustomParam']('CUSTOM_PARAM','CUSTOM_VALUE');
        mwbs['MWBsetActiveSubcodes'](constants.MWB_CODE_MASK_EANUPC | constants.MWB_SUBC_MASK_C25_STANDARD);
	}
	catch(e){
		console.log(e);
	}
...
MWBSInitSpace.callback = function(result){
    console.log('scanns MWBSInitSpace.callback Invoked at: '+ (new Date()).getTime());
